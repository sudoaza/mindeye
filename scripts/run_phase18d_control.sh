#!/usr/bin/env bash
# Phase 18D-control: EEG → spatial_768x4x4 code, probe-on, warm-started from Phase 16c with --loss spatial_cosine (old loss)
#
# Run on RunPod: bash scripts/run_phase18d_control.sh
...
SLUG="phase18d_control_eeg_to_rae_4x4"
...
# ============================================================
# Step 3: Train EEG — warm-started from Phase 16c with spatial_cosine (old loss)
# ============================================================
echo ""
echo "=== Step 3: Training EEG encoder — Phase 18D-control (warm-start from 16c, spatial_cosine loss) ==="
...
echo ""
echo "=== Step 4: Evaluating Phase 18D-control ==="
python3 scripts/evaluate_rae_spatial.py \
    ...
    --num-samples 200 \
    --output-dir outputs/phase18d_control_rae_spatial_eval \
    --device cuda

echo ""
echo "=== Phase 18D-control complete! ==="
echo "  Run dir: $RUN_DIR"
echo "  Metrics: outputs/phase18d_control_rae_spatial_eval/generation_metrics.json"
echo "  Grid:    outputs/phase18d_control_rae_spatial_eval/generation_grid.png"
